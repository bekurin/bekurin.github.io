...
import { getMapImageUrl } from '../utils/mapImage'
...
function MapCard({ map }: MapCardProps) {
  ...
  const imageUrl = getMapImageUrl(map.mapName)
  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] bg-background">
        ...
        <span
          className={`absolute left-2 top-2 z-10 rounded px-2 py-0.5 text-xs font-medium text-white ${getModeColor(map.mode)}`}
        >
